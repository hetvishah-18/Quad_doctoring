...
#ifndef _LIBRARIES_20250804140756_
#define _LIBRARIES_20250804140756_
...
__asm__(".ascii \"iecfile \\\"Logical/Libraries/vclib/VCLIB.typ\\\" scope \\\"global\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Libraries/vclib/VCLIB.fun\\\" scope \\\"global\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/Libraries/vclib/VCLIB.var\\\" scope \\\"global\\\"\\n\"");
...
#endif
#ifdef _VCLIB_EXPORT
	__asm__(".ascii \"plcexport \\\"VCEV_Count\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_Pop\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_Free\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_DblGet\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_FltGet\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_I32Get\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_Utf16Get\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCEV_Utf8Get\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_DPID2Index\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetDecimalPlaces\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetUGID\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetUnits\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetUTextId\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_Initialize\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_UserID2Index\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetActivePVIndex\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetPVInfo\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetPVName\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_Utf16Get\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_Utf16Set\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_Utf8Get\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_Utf8Set\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetLimits\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCDP_GetUserIDbyName\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCLIB_RegisterEVClient\\\" FUN\\n\"");
	__asm__(".ascii \"plcexport \\\"VCLIB_RegisterDPClient\\\" FUN\\n\"");
#endif
...
#endif /* _LIBRARIES_20250804140756_ */
