...
export AS_TEMP_PATH := C:/Projects/Tension\ Control/Doctor/Temp
export AS_CONFIGURATION := 5Drive
export AS_BINARIES_PATH := C:/Projects/Tension\ Control/Doctor/Binaries
...
export WIN32_AS_PROJECT_PATH := "C:\Projects\Tension Control\Doctor"
...
export WIN32_AS_TEMP_PATH := "C:\Projects\Tension Control\Doctor\Temp"
export WIN32_AS_BINARIES_PATH := "C:\Projects\Tension Control\Doctor\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Doctor.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Rebuild'   
